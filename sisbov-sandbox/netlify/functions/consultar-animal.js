...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    if (numeroSisbov === '123456789012345') {
      filePath = path.resolve(__dirname, '../../src/api-examples/consultarDadosAnimal_response_success.xml');
    } else {
      filePath = path.resolve(__dirname, '../../src/api-examples/consultarDadosAnimal_response_error.xml');
    }
